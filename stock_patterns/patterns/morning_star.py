"""Morning Star — bearish candle, small-bodied star, bullish confirmation."""
...
def generate(seed: int | None = None, with_context: bool = True) -> pd.DataFrame:
    ...
    c1 = make_candle(
        ...
        lower_wick=body1 * rng.uniform(0.1, 0.35),
    ...
    c3_open = max(c2.open, c2.close) + body1 * rng.uniform(0.0, 0.1)
